...
\begin{cventries}
  ...
  %---------------------------------------------------------
  \cventry
  {TypeScript, VS Code API, Mocha} % Affiliation/role
  {CodeWall} % Organization/group
  {\href{https://github.com/abhinavk99/codewall}{github.com/abhinavk99/codewall}} % Location
